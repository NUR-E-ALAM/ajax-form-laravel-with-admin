    ...
    >
        ...
        <div class="w-full flex flex-col text-slate-300 nav-links mt-8">
            <div class="w-full flex flex-col">
                ...
                <x-navigation-link :href="route('exam-list.index')" :text="__('Exam List')" />
                <x-navigation-link :href="route('university-list.index')" :text="__('University List')" />
                <x-navigation-link :href="route('board.index')" :text="__('Board List')" />
                <x-navigation-link :href="route('application.index')" :text="__('Application List')" />
